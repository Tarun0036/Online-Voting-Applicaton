...
*{
    ...
    .divs:nth-child(1)
    {
        ...
        background-image: linear-gradient(rgb(154, 56, 253),white);
        justify-content: space-evenly;
...
<div id="nav">
    ...
    <div id="signUp">
        <div class="divs">
            <form id="myForm" action="voterLogin">
            <div class="formDivs">
        ...
        <div class="formDivs">
           <u><a href="VoterRig.jsp">Dont have have Account?</a></u>
   </div>
   <%
			...
			{
			%>
			<h2 style="color:red;padding-left: 210px"><%=status %></h2>
			<%
			}
			%>
        </form>
