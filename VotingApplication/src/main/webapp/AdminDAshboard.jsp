...
<%@page import="com.jsp.VotingApplication.Entity.Admin"%>
...
<body>
    ...
    <div id="nav">
        ...
        <button><a href="">WelCome <%= add.getUsername()%></a></button>
        <button><a href="viewAllAdmins">View Admins</a></button>
        <button><a href="getVoters">View Voters</a></button>
        <button><a href="AllCandies">View Candidates</a></button>
    </div>
    <div id="container">
        <u><h1>Admin Dashboard</h1></u><br>
     <div id="innerCont">
        <table>
            <tr style="background-image: linear-gradient(90deg,orange,rgb(114, 179, 237));">
              <th>Candidate Name</th>
              <th>No. of Votes</th>
            </tr>
            <%
			List<CandidateList> li = (List) request.getAttribute("listOfCans");
			for (CandidateList can : li){
			%>
            <tr>
                <th><div style="display: flex;flex-direction: row;justify-content: flex-start;align-items:center;column-gap: 5px;"><img style="width: 3em;height: 3em;border-radius: 100%;" src="./candi.jpg" alt="Candidate"> <%=can.getcName()%></div></th>
                <th><div style="display: flex;flex-direction: row;justify-content: flex-start; justify-content: center;align-items: center;column-gap: 5px;"><%=can.getVotes()%> <img style="width: 3em;height: 3em;border-radius: 100%;" src="./ballot.jpg" alt="ballot"></div></th>
