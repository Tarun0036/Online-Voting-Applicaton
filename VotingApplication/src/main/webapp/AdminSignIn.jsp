...
*{
    ...
    .divs:nth-child(1)
    {
        ...
        background-image: linear-gradient(rgb(113, 197, 231),aliceblue);
        justify-content: space-evenly;
        box-shadow: 2px 3px 10px rgb(152, 152, 152);
    }
    .divs:nth-child(2)
    {
        display: flex;
...
<div id="nav">
        ...
        <button><a href="VoterRig.jsp">VoterRegistration</a></button>
        <button><a href="SignIn.jsp">VoterSignIn</a></button>
        <button><a href="">About</a></button>
    </div>
    <div id="signUp">
        <div class="divs">
            <form id="myForm" action="adminLogin">
            <div class="formDivs">
                <u><h1 style="box-shadow: 2px 2x 2px white;">Admin SignIn</h1></u>
            </div>
            <div class="formDivs">
            ...
            <div class="formDivs">
                 <input class="butts" type="submit" value="Login">
        </div>
        <%
        ...
        <div class="divs">
            <img src="./Computer login.gif" alt="img">
        </div>
    </div>
</body>
</html>